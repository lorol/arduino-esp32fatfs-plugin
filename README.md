...
- You need an executable to create the image. See for Win in [extra](https://github.com/lorol/arduino-esp32fatfs-plugin/extra) or take [mkfatfs tool](https://github.com/labplus-cn/mkfatfs/releases/tag/v1.0)  Thanks to [labplus-cn](https://github.com/labplus-cn/mkfatfs)
